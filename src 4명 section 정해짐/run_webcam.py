    ...
    with tf.Session(config=sess_config) as sess:
        ...
        while True:
            ...
            # pubis = 18
                ...
                # print(joint_pixelX)
                image_rgb, checkPerson, trueHumanCount, joint_pixelX, joint_pixelY, human_match = TfPoseEstimator.draw_humans(image_rgb, humans, joint_pixelX, joint_pixelY, human_match, imgcopy=False)
                print("0:" + str(joint_pixelX[0][1]) + "  1:" + str(joint_pixelX[1][1]) + "  2:" + str(joint_pixelX[2][1]) + "  3:" + str(joint_pixelX[3][1]))
