...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelpath', type=str, default='/data/private/SSJointTracker_train/')
    parser.add_argument('--logpath', type=str, default='/data/private/SSJointTracker_train/')
    ...
    with tf.Session(config=config) as sess:
        ...
        if args.checkpoint:
            ...
            if '.ckpt' in pretrain_path:
                ...
                pretrain_path = '/home/soosang/SSJointTracker_alpha/models/numpy/openpose_coco.npy'
