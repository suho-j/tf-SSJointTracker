...
joint_pixelX = [[1 for i in range(20)] for j in range(4)]  # record coordinates-X
joint_pixelY = [[1 for i in range(20)] for j in range(4)]  # record coordinates-Y
joint_dist = [[0 for i in range(20)] for j in range(4)]  # distance array values setup
...
point3dX = [[1 for i in range(20)] for j in range(4)]  # for return value of axisX
point3dY = [[1 for i in range(20)] for j in range(4)]  # for return value of axisY
point3dZ = [[0 for i in range(20)] for j in range(4)]  # distance array values setup
last_jointX = 0
last_jointY = 0
        ...
        while True:
            ...
            if humans:
                ...
                if trueHumanCount > 0:
                    ...
                    for i in range(4):
                        # 목 데이터가 1이면 Human 데이터가 없는 것으로 판단하고 continue
                        if joint_pixelX[i][1] == 1:
                            for _ in range(20):
                                point3dX[i][_] = 1
                                point3dY[i][_] = 1
                                point3dZ[i][_] = 0
                ...
                #                 (joint_pixelX[i][list_angle[j]], joint_pixelY[i][list_angle[j]]),
