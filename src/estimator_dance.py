        ...
        for j in range(trueHumanCount):
            ...
            # if True:
                for i in range(common.CocoPart.Background.value):
                    ...
                    if not joint_pixelX[human_section][8] == 1 and not joint_pixelX[human_section][11] == 1:
                        joint_pixelX[human_section][18] = int((joint_pixelX[human_section][8] + joint_pixelX[human_section][11]) / 2)
                        joint_pixelY[human_section][18] = int((joint_pixelY[human_section][8] + joint_pixelY[human_section][11]) / 2)
                ...
                for pair_order, pair in enumerate(common.CocoPairsRender):
                    ...
                    if wrist_check == 1 and (pair[0] == 1 or pair[0] == 8 or pair[0] == 11):
                        ...
                        npimg = cv2.line(npimg, centers[pair[0]], wrist_inference,
                                         (rgb[human_section][0], rgb[human_section][1], rgb[human_section][2]), 3)
