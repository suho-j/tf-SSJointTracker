    ...
    with tf.Session(config=sess_config) as sess:
        ...
        while True:
            ...
            # pubis = 18
                ...
                # print(joint_pixelX)
                image_rgb, checkPerson, trueHumanCount, joint_pixelX, joint_pixelY, human_match = TfPoseEstimator.draw_humans(image_rgb, humans, joint_pixelX, joint_pixelY, human_match, depth_data_array, imgcopy=False)
